...
class Var(object):
    ...
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", " 5010466936").split())  
    NO_PORT = bool(getenv('NO_PORT', False))
    APP_NAME = None
    OWNER_USERNAME = str(getenv('OWNER_USERNAME', 'EARN4SHAREUSER'))
    if 'DYNO' in environ:
        ON_HEROKU = True
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', '-1001798208356'))
